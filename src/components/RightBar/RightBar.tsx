      ...
      <div>
        ...
        <div className="px-3">
          <div className="flex gap-x-4">
            ...
            <div className="text-[16px] font-semibold text-gray-800 dark:text-white/70">
              <h4>Ive x Pepsi</h4>
              <p className="text-gray-600 dark:text-white/50 text-xs"> Pepsi and I've team up for a new, one-of-a-kind flavor! try the new Pepsi Ive and enjoy the refeshing combination of Pepsi's taste and Ive's music. Available now!</p>
            </div>
          </div>
